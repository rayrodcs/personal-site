...
export function Navbar() {
  return (
    <header className="sticky top-0 z-30 border-b border-[var(--borderBlue)] bg-[rgba(5,9,20,0.82)] backdrop-blur-xl">
      <nav className="mx-auto flex h-24 max-w-[1760px] items-center justify-between px-5 sm:px-8 lg:px-12 xl:px-16">
        <a href="#home" className="group inline-flex items-center" aria-label="Ray Rodriguez home">
          <RRLogo className="h-12 w-[92px] transition duration-200 group-hover:drop-shadow-[0_0_18px_rgba(46,168,255,0.45)]" />
        </a>
